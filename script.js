const siteConfigs = {
  "do1ruky.cz": {
    ...
    headline: "Do1Ruky přiveze food truck přímo na vaši akci.",
    heroText:
      "Varianta pro Do1Ruky je postavená pro mobilní gastro službu, festivaly, firemní akce i soukromé oslavy. Web může rychle odprezentovat menu, termíny i možnost rezervace.",
    ...
    aboutParagraphs: [
      "Do1Ruky je mobilní gastro koncept pro akce, kde má jídlo být rychlé, výrazné a bez zbytečné složitosti.",
      "Hodí se na festivaly, firemní dny i soukromé oslavy, kde chcete pohodový provoz a jídlo, které baví.",
    ],
    ...
    eventsNote: "Malá i velká akce, podle prostoru a počtu hostů.",
    ...
    inquiryTitle: "Chcete food truck na akci?",
    inquiryText: "Pošlete základní informace a připravíme vám nezávaznou nabídku.",
    inquiryItems: ["typ akce", "počet lidí", "místo a termín"],
    inquiryNote: "Ozveme se rychle a navrhneme vhodné řešení.",
...
if (brandButtons.do1ruky) {
  brandButtons.do1ruky.addEventListener("click", () => applyConfig("do1ruky.cz"));
}
